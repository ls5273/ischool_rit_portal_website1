...
## ✨ Key Features:
- **Custom MVC Architecture:** The codebase is strictly organized using the Model-View-Controller design pattern via ES6 modules. This cleanly separates data handling, UI rendering, and user input logic.Live Data - **Integration:** Utilizes axios to perform asynchronous HTTP requests, fetching live institutional data directly from the iSchool API.
